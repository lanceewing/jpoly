...
public class StackTest extends Framework {
  ...
  public void testPSHSall() {
    ...
    assertEquals(0x0B, myTestCPU.read(517 - 2)); // Check that PC-high is
                                                 // pushed.
  ...
  /**
   * Test the PULS - Pull all registers from Hardware Stack. The stack grows
   * downwards, and this means that when you PULL, the stack pointer is
   * increased.
   */
  @Test
  ...
  /**
   * Test the PULU - Pull all registers from Hardware Stack. The stack grows
   * downwards, and this means that when you PULL, the stack pointer is
   * increased.
   */
  @Test
  ...
  /**
   * Test the PULS - Pull registers from Hardware Stack - instruction. The stack
   * grows downwards, and this means that when you PULL, the stack pointer is
   * increased.
   */
  @Test
