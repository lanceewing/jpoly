...
public class SubtractionTest extends Framework {
  ...
  /**
   * Test indirect mode: CMPA ,Y+ We're subtracting 0xff from 0xff and
   * incrementing Y
   */
  @Test
  public void testCMP() {
  ...
  /**
   * Test the subtraction with carry instruction. B=0x35 - addr(0x503)=0x3 - C=1
   * becomes 0x31
   */
  @Test
  ...
  /**
   * Test the SUBA instruction. The overflow (V) bit indicates signed two’s
   * complement overflow, which occurs when the sign bit differs from the carry
   * bit after an arithmetic operation.
   */
  @Test
  ...
  /**
   * Test the subtraction instruction. IMMEDIATE mode: B=0x02 - 0xB3 becomes
   * 0x4F positive - negative = positive
   */
  @Test
  ...
  /**
   * Test the subtraction instruction. IMMEDIATE mode: B=0x02 - 0x81 becomes
   * 0x81 positive - negative = negative + overflow
   */
  @Test
  ...
  /**
   * Test INDEXED mode: SUBA B,S where B is negative. A = 0x99 B = 0xF2 = -14 S
   * = 0x210 Read location at stack pointer (0x210) - 14 = 0x202. Value is 0x73.
   * 0x99 - 0x73 = 0x26 negative - positive = positive + overflow The overflow
   * (V) bit indicates signed two’s complement overflow, which occurs when the
  ...
  /**
   * Test INDEXED mode: SUBB A,S where A is negative. B = 0x40 A = 0xF2 = -14 S
   * = 0x210 Read location at stack pointer (0x210) - 14 = 0x202. Value is 0x73.
   * 0x40 - 0x73 = 0xCD positive - positive = negative
   */
  @Test
  ...
  /**
   * Example from Programming the 6809. 0x03 - 0x21 = 0xE2 positive - positive =
   * negative
   */
  @Test
  ...
  /**
   * Test the subtraction instruction for D. We subtract the content of the DP +
   * 0 D=0x7702 - addr(0200)=0x0123 becomes 0x75DF positive - positive =
   * positive
   */
  @Test
  ...
  /**
   * Test the subtraction instruction for D. We subtract the content of the DP +
   * 0 D=0x0705 - 0x0123 becomes 0x05E2 positive - positive = positive
   */
  @Test
  ...
  /**
   * Test the subtraction instruction for D. We subtract the content of the DP +
   * 0 D=0x0702 - 0xF123 becomes 0x15DF positive - negative = positive
   */
  @Test
